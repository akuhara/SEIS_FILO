...
SEIS_FILO's programs involve a number of tuning parameters. The complete list is given here. These parameters should appear in the  [main parameter file](main_parameter_file.md) or [data summary file](https://github.com/akuhara/SEIS_FILO/wiki/Data-Summary-File). 
...
**Note:** If this parameter is set to be less than 0, full search mode is activated. See [here](https://github.com/akuhara/SEIS_FILO/wiki/Surface-Wave) for more details. 
 
* Type: Integer

### n_disp
The number of [data files](https://github.com/akuhara/SEIS_FILO/wiki/Data-File) for dispersion data. Only used for inversion. Need to specify in the first line of the [data summary file](https://github.com/akuhara/SEIS_FILO/wiki/Data-Summary-File). 
* Type: Integer
...
See [here](https://github.com/akuhara/SEIS_FILO/wiki/Receiver-Function-Amplitude) for more details.
* Type: Logical (T or F)
...
### n_rf
The number of [data files](https://github.com/akuhara/SEIS_FILO/wiki/Data-File) for receiver function data. Only used for inversion. Need to specify in the first line of the [data summary file](https://github.com/akuhara/SEIS_FILO/wiki/Data-Summary-File). 
* Type: Integer
...
Input filename that contains a velocity model for the forward computation.
* Type: Character (length=200)
...
### n_proc
The number of processes. __NOTE:__ this parameter should be passed as command line arugment: `mpirun -np [n_proc] bin/joint_int joint_inv.in`, for example. ❌ DONOT put this parameter in any input files.
* Type: Integer
...
This parameter is valid only if [solve_anomaly](https://github.com/akuhara/SEIS_FILO/wiki/Parameter-List#solve_anomaly) 
is true. 
* Type: double precision 
...
### ref_vmod_in
A filename that contains a reference velocity model. This parameter is valid only if [solve_anomaly](https://github.com/akuhara/SEIS_FILO/wiki/Parameter-List#solve_anomaly) 
is true. 
* Type: Character (length=200)
...
### disper_in
The filename of the [data summary file](https://github.com/akuhara/SEIS_FILO/wiki/Data-Summary-File) for dispersion curves.
* Type: Character (length=200)

### recv_func_in
The filename of the [data summary file](https://github.com/akuhara/SEIS_FILO/wiki/Data-Summary-File) for receiver functions.
* Type: Character (length=200)
